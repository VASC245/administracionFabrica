...
const registros = ref([])
const nuevo = ref({
  fecha: '', hora: '', jampa: null, viruta: null, pellet: null,
  temperatura_entrada: null, temperatura_salida: null, humedad: null, amperios: null
})
...
const guardar = async () => {
  if (editMode.value) {
    ...
    if (!error) {
      ...
      nuevo.value = { fecha: '', hora: '', jampa: null, viruta: null, pellet: null, temperatura_entrada: null, temperatura_salida: null, humedad: null, amperios: null }
      await cargar()
    }
  } else {
